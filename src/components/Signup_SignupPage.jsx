...
function Signup() {
    ...
    const signUp = async (e) => {
        ...
        setError('')
        try {
            const response = await axios.post('http://localhost:3001/api/user/sign-up', userData)
    ...
    return (
        <div className="SignUp">
            ...
            <div className="sign-up">
                ...
                <form className="sign-up-info" onSubmit={signUp}>
                    ...
                    <div className="confirm-sign-up-password">
                        ...
                        <input type="password" id="inputyourpassword" placeholder="Password" name='confirmpassword' value={userData.confirmpassword} onChange={changeInputHandle} />
                    </div>
                    ...
                    <div className="remember-have">
                        ...
                        <Link to="/sign-in" className="have">Already have an account?</Link>
                    </div>
                    <div className="sign-in-btn">
                        <button type='submit' id="btnsn">SIGN UP</button><br />
                        <div className="sign-in-please">
                            <Link to="/sign-in" id="havebtn">SIGN IN</Link>
                        </div>
                    </div>
                </form>
